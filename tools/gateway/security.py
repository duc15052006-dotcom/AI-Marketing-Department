...
class SecurityValidator:
    ...
    def validate_url(cls, url: str, allowed_domains: Optional[List[str]] = None) -> str:
        ...
        try:
            ...
            # Hostname is a domain name; perform a fail-closed DNS resolution pre-check.
    ...
    def resolve_public_addresses(cls, hostname: str, port: Optional[int] = None):
        ...
        Resolution fails closed.  Callers that establish sockets should connect to
        one of the returned sockaddr values directly rather than resolving the host
        again; this closes the DNS-rebinding/TOCTOU gap between validation and use.
        """
        try:
