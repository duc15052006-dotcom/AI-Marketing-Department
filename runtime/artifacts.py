...
class DepartmentRunArtifact(BaseModel):
    ...
    def _integrity_payload(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "knowledge_used": _normalize_for_hashing(self.knowledge_used),
            "memory_used": _normalize_for_hashing(self.memory_used),
            "capabilities_used": _normalize_for_hashing(self.capabilities_used),
            "artifacts": _normalize_for_hashing(self.artifacts),
            "lineage_summary": _normalize_for_hashing(self.lineage_summary),
