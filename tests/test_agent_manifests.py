...
class TestAgentDefinitions(unittest.TestCase):
    ...
    def test_exactly_five_permanent_agents_exist(self):
        """Exactly five canonical agent subdirectories exist, no sixth permanent agent."""
    ...
    def test_every_agent_has_valid_agent_md(self):
        """Every canonical agent directory contains agent.md with valid unique frontmatter."""
    ...
    def test_duplicate_agent_names_fail(self):
        agent_names = ["cmo", "intelligence", "content", "creative", "cmo"]
        with self.assertRaises(AssertionError):
    ...
    def test_sixth_permanent_agent_fails(self):
        six_agents = ["cmo", "intelligence", "content", "creative", "performance", "affiliate_manager"]
        with self.assertRaises(AssertionError):
