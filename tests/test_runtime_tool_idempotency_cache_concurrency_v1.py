...
class _CreativeRuntime(FiveAgentDepartmentRuntime):
    def __init__(self, tool_gateway: _CoordinatedToolGateway) -> None:
        # Deliberately avoid the production composition root: this regression
        # isolates only the runtime's same-key dispatch cache boundary.
    ...
    def _finalize_stage_handoff(self, context: Any, stage_key: str, agent_name: str, raw_output: str, output: dict):
